...
const Work = () => {
  return (
    <div name="work" className='bg-polka bg-repeat w-full h-full lg:h-screen'>

        <div className='justify-center items-center w-full h-full fade'>
            <div className='flex flex-col lg:flex-row top-[25%] relative h-[50%] lg:w-[85%] lg:m-auto'>

                <div className='lg:flex-col lg:relative md:relative lg:top-[-290px] 2xl:top-[-225px] md:mt-[100px]'>
                    <div className='lg:w-[75%] w-[80%] m-auto outline outline-2 rounded-tr-lg rounded-bl-lg rounded-[30px] bg-black/40 mt-[75px] md:mt-[25px] '>
                        <div className='outline outline-2 m-1 rounded-tr-lg rounded-bl-lg rounded-[30px]'>
                            <h1 className='py-3 px-6 text-[2.5rem] mlg:text-[2rem] underline text-center'>Experience</h1>
                    ...
                    <div className='lg:w-[75%] w-[80%] m-auto outline outline-2 rounded-tl-lg rounded-bl-lg rounded-[30px] bg-black/40 mt-[25px]'>
                        <div className='outline outline-2 m-1 rounded-tl-lg rounded-bl-lg rounded-[30px]'>
                            <h1 className='py-3 px-6 text-[2.25rem] mlg:text-[2rem] underline text-center'>Education</h1>
                ...
                <div className='lg:w-[40%] w-[80%] m-auto outline outline-2 rounded-tl-lg rounded-br-lg rounded-[30px] bg-black/40 mt-[25px] mb-[50px] md:mb-[50px] lg:mb-[auto]'>
